...
var me = "style[".concat(f, "][").concat("data-styled-version", '="').concat("6.0.2", '"]');
...
var we = function(e) {
  ...
  o2.setAttribute(f, "active"), o2.setAttribute("data-styled-version", "6.0.2");
  var i2 = Se();
...
function Qe(e, r2, s2) {
  var i2 = ee(e), a2 = e, c2 = !M(e), p2 = r2.attrs, d = void 0 === p2 ? b : p2, h = r2.componentId, f2 = void 0 === h ? function(e2, t) {
    ...
    Ze[n] = (Ze[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(x("6.0.2" + n + Ze[n]));
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      ...
      for (var w3 in v3)
        void 0 === v3[w3] || "$" === w3[0] || "as" === w3 || "theme" === w3 || ("forwardedAs" === w3 ? S3.as = v3.forwardedAs : y3 && !y3(w3, g3) || (S3[w3] = v3[w3], y3 || false || isPropValid(w3) || Ke.has(w3) || (Ke.add(w3), console.warn('styled-components: it looks like an unknown prop "'.concat(w3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
...
var ut = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      var t = e2.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.2", '"')].filter(Boolean), " ");
      ...
      if (e2.sealed)
        throw ce(2);
      var r2 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.2", n.dangerouslySetInnerHTML = { __html: e2.instance.toString() }, n), s2 = Se();
